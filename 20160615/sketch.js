...
function Blob(parent, radius, size, num, hue){
  ...
  var linemat = new THREE.LineBasicMaterial({color:0xffffff, blending:THREE["AdditiveBlending"], transparent:true, opacity:0.5, vertexColors:THREE.VertexColors});
  ...
  for(var i=0; i<num; i++){
    ...
    c.setHSL(hue, 1, Math.random()*0.5);
    colors.push(c);
