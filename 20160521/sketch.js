...
function setup(){
  ...
  noStroke();
  //fill(255,32);
  rings.push(new Ring(100, 20, color(255,0,0,128)));
  rings.push(new Ring(150, 30, color(255,128,0,128)));
  rings.push(new Ring(200, 40, color(255,255,0,128)));
  rings.push(new Ring(250, 50, color(128,255,0,128)));
  rings.push(new Ring(300, 60, color(0,255,128,128)));
  rings.push(new Ring(350, 70, color(0,255,255,128)));
}
